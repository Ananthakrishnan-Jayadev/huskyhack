...
export const decisions = [
  ...
  },
  {
    ...
    realDataNote: "US showcase tournaments cost $1,000-$2,000 per weekend including travel for Canadian families."
  },
  {
    id: 'family-pressure',
    age: 13,
    framing: "Mom's hours got cut at the long-term care home. Sister starts braces in the fall. The OPDL invoice for next year sits on the kitchen table. He's been training six days a week.",
    choices: [
    ...
    realDataNote: "Statistics Canada has reported immigrant families are roughly 32% less likely to enroll their children in sports than Canadian-born families."
  },
  {
    id: 'the-fork',
    age: 15,
    framing: "At 15, the path splits. You've made it this far, but the costs for the Elite Academy residence are doubling.",
    choices: [
    ...
    realDataNote: "Free Footie is a real Edmonton-based program founded specifically because the official soccer pipeline is unaffordable."
  }
];

// ENSURE THIS IS BELOW THE DECISIONS ARRAY
export const terminalDecisions = {
  ...
  lateGame: {
    ...
    age: 15,
    framing: "The scout camp invitation is on the kitchen table. The flights to Burnaby alone are eight hundred and fifty dollars. He doesn't know about the invitation yet.",
    choices: [
      { id: 'tell-tonight', label: "Tell him after dinner.", budgetDelta: 0 },
